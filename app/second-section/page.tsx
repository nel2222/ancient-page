        ...
        <div className="p-5 justify-center md:w-1/3">
          <div
            className="
                ...
                "
          >
            From Noobie to Expert, Ancientech is built for every type of
            student.
          </div>
          <div className="text-2xl mb-8">
            Built for all student and enterprenures, Ancientech is the only
            platform you need to grow your skills in cybersecurity.
          </div>
