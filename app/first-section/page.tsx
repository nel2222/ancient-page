      ...
      <div className="container mx-auto text-center">
        <div
          className="text-6xl flex justify-center font-bold md:px-20 pb-10
            ...
            "
        >
          Empowering Minds, Shaping Futures: Where Learning Meets Excellence
        </div>
        ...
        <p
          className="text-lg md:text-xl md-10
            ...
            "
        >
          Unlock your potential, embrace new challenges, and set the foundation
          for a bright future.
          <br />
          Every step you take here is a step toward your success!.
        </p>
